                      ...
                      {nftFull && (
                        <>
                          <div className="flex justify-between items-center px-4 py-3">
                            ...
                            <span className={`font-bold ${rankColor(nftFull.correctedRank, totalSupply)}`}>#{nftFull.correctedRank} <span className="text-gray-500 font-normal">/ {totalSupply}</span></span>
                          </div>
                          <div className="flex justify-between items-center px-4 py-3">
